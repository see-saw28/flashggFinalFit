...
experimental_systematics = [
                ...
                {'name':'weight_TriggerSF','title':'CMS_hgg_TriggerSF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                ...
                {'name':'weight_LoosePhoIDSF','title':'CMS_hgg_phoIdMva','type':'factory','prior':'lnN','correlateAcrossYears':1},
...
signal_shape_systematics = [
                ...
                # {'name':'ScaleEBZee','title':'ScaleEBZee','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZee'},
                # {'name':'ScaleEEZee','title':'ScaleEEZee','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZee'},
                # {'name':'ScaleEBZmmg','title':'ScaleEBZmmg','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZmmg'},
                # {'name':'ScaleEEZmmg','title':'ScaleEEZmmg','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZmmg'},

                {'name':'ScaleZee_EB_lowR9','title':'ScaleZee_EB_lowR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZee'},
                {'name':'ScaleZee_EB_highR9','title':'ScaleZee_EB_highR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZee'},
                {'name':'ScaleZee_EE_lowR9','title':'ScaleZee_EE_lowR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZee'},
                {'name':'ScaleZee_EE_highR9','title':'ScaleZee_EE_highR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':'ScaleZee'},
                {'name':'ScaleZmmg_centralEB_lowR9','title':'ScaleZmmg_centralEB_lowR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgStat']},
                {'name':'ScaleZmmg_centralEB_highR9','title':'ScaleZmmg_centralEB_highR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgStat']},
                {'name':'ScaleZmmg_outerEB_lowR9','title':'ScaleZmmg_outerEB_lowR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgStat']},
                {'name':'ScaleZmmg_outerEB_highR9','title':'ScaleZmmg_outerEB_highR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgStat']},
                {'name':'ScaleZmmg_EE_lowR9','title':'ScaleZmmg_EE_lowR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgStat']},
                {'name':'ScaleZmmg_EE_highR9','title':'ScaleZmmg_EE_highR9','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgStat']},
                {'name':'ScaleNonLinearity_EB_highPt','title':'ScaleNonLinearity_EB_highPt','type':'signal_shape','mode':'scalesCorr','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgNL']},
                {'name':'ScaleNonLinearity_EE_highPt','title':'ScaleNonLinearity_EE_highPt','type':'signal_shape','mode':'scalesCorr','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgNL']},
                {'name':'ScaleZmmgScaRe','title':'ScaleZmmgScaRe','type':'signal_shape','mode':'scales','mean':'0.0','sigma':'1.0', 'group':['ScaleZmmg', 'ScaleZmmgScaRe']},
  

                {'name':'Smearing','title':'Smearing','type':'signal_shape','mode':'smears','mean':'0.0','sigma':'1.0', 'group':'Smearing'},
